...
import com.farzine.app.MessageType;
import com.farzine.emoji.Emogi;
import com.farzine.emoji.Model_Emoji;
import com.farzine.event.PublicEvent;
import com.farzine.main.Main;
...
import com.farzine.swing.WrapLayout;
...
public class Panel_More extends javax.swing.JPanel {
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/farzine/icon/image.png")));
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/farzine/icon/link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();
